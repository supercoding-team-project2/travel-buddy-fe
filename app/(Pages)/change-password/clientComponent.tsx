...
export function ChangePasswordClient() {
  ...
  return (
    <>
      {isPasswordChanged ? (
        <Alert errorMessage="비밀 번호가 변경되었습니다" buttonText="Login" nextLink="/login" />
      ) : (
        <div className={cx('ChangePassword')}>
          ...
          <div className={cx('rightWrapper')}>
            ...
            <div className={cx('container')}>
              <form className={cx('formContainer')} onSubmit={checkAccountAndSendCode}>
                {isRegistered === null ? (
                  <>
                  ...
                  <>
                    ...
                    <button className={cx('submitButton')} onClick={changePassword}>
                      Apply
                    </button>
                  </>
                )}
