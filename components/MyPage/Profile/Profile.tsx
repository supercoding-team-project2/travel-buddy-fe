        ...
        <div className={cx("each-navigation")}>
          <div className={cx("each-navigation-container")} onClick={() => clickNavHandler("course")}>
            <Image
              src={downArrow}
              alt="down arrow"
              className={cx("down-arrow", {"down-arrow-active": isMyCourseOpen})}
            />
            내 경로 목록
          </div>
        ...
        <div className={cx("each-navigation")}>
          <div className={cx("each-navigation-container")} onClick={() => clickNavHandler("post")}>
            <Image
              src={downArrow}
              alt="down arrow"
              className={cx("down-arrow", {"down-arrow-active": isMyPostOpen})}
            />
            내가 작성한 후기 
          </div>
        ...
        <div className={cx("each-navigation")}>
          <div className={cx("each-navigation-container")} onClick={() => clickNavHandler("info")}>
            <Image
              src={downArrow}
              alt="down arrow"
              className={cx("down-arrow", {"down-arrow-active": isMyInfoOpen})}
            />
            내 정보
          </div>
