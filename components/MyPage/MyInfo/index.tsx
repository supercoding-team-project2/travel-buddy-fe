...
const MyInfo = ({ profilePic, setProfilePic, token }: Props) => {
      ...
      <div className={cx('myinfo-div')}>
        ...
        <div className={cx('picture-container')}>
          <div className={cx('image-container')}>
            <Image src={profilePic} alt="user-image" className={cx('user-image')} width={120} height={120} />
          </div>
          <div className={cx('modify-container')}>
            <button className={cx('modify-button')}>
              <label htmlFor="image-change-input" className={cx('modify-label')}>
                프로필 사진 수정
              </label>
              <input
